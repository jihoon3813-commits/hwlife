      ...
      <div className="h-full flex flex-col justify-center px-16 text-white relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <h3 className="text-4xl font-black leading-tight text-white mb-3 break-keep">
            상조회사 폐업 걱정 NO! <span className="text-[#3182F6]">100% 안심 효원상조</span>
          </h3>
        ...
        <div className="flex flex-col gap-5 relative z-10 w-full max-w-5xl mx-auto">
          ...
          <div className="bg-white/5 border border-white/10 rounded-[28px] p-6 flex items-center justify-between gap-8 backdrop-blur-xl hover:border-white/20 transition-all duration-300">
            <div className="flex items-center gap-5 w-[310px] shrink-0">
              <div className="w-14 h-14 rounded-2xl bg-[#3182F6]/10 flex items-center justify-center text-[#3182F6] shrink-0">
                <ShieldCheck className="w-7 h-7" />
              </div>
              <div>
                <span className="text-[#3182F6] text-xs font-bold block mb-1">선수금 기준 업계 탑클래스</span>
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white/90 text-[15px] font-medium leading-relaxed break-keep">
                효원상조는 공정거래위원회에 등록된 상조업체 중 선수금 기준 <span className="text-[#3182F6] font-bold">12위(약 1,200억 원)</span>에 속하는 탄탄하고 건실한 상조회사입니다. 철저한 재무 건전성으로 어떠한 시장 변화에도 소중한 고객의 자산을 안전하게 지킵니다.
              </p>
            </div>
            <a 
              ...
              className="flex items-center justify-center gap-2 bg-[#3182F6] hover:bg-[#1b64d2] text-white py-3.5 px-5 rounded-2xl text-sm font-black transition-all duration-300 pointer-events-auto shrink-0 shadow-lg shadow-blue-500/10 hover:shadow-blue-500/30"
            >
              현황 조회 <ExternalLink className="w-4 h-4" />
            </a>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-[28px] p-6 flex items-center justify-between gap-8 backdrop-blur-xl hover:border-white/20 transition-all duration-300">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white/90 text-[15px] font-medium leading-relaxed break-keep">
                폐업한 상조 회원에게 기존 납입금의 50% 금액으로 온전한 서비스를 보장합니다. 전체 상조사 중 공정위의 엄격한 기준으로 선정된 <span className="text-[#00C853] font-bold">단 16개사만 참여</span>하고 있어, 참여 자체가 압도적인 기업 안정성을 증명합니다.
              </p>
            </div>
            <a 
